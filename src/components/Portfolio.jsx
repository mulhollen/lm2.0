      ...
      <div className="portfolioContent">
        <Link className="portLink" to='/HstreamStore'>
          <div className="d-flex justify-content-center yellow   flip">
            <div className="d-flex flex-column justify-content-between h-100 w-50 p-5">
            ...
            <img className="pl-0  w-50" src={Hstream} alt="Laptop computer opened to a healthcare education marketplace website with a banner for covid education" />
          </div>
        </Link>
        ...
        <Link className="portLink" to='/ArtInvestigator'>
          <div className="d-flex justify-content-center yellow   flip">
            ...
            <img className="pl-0  w-50" src={AI} alt="iPad view of Art Investigator App home page with aligator illustration and buttons to get started" />
          </div>
        </Link>
        <img src={Squiggle} className="portfolioContent__lineBreak" alt=" " />
        <Link className="portLink" to='/Canvas'>
          <div className="d-flex justify-content-center yellow   flip">
            ...
            <img className="pl-0  w-50" src={CanvasImg} alt="graphic of painters pallet with the word canvas" />
          </div>
        </Link>
        <img src={Squiggle} className="portfolioContent__lineBreak" alt=" " />
        <Link className="portLink" to='/EverythingHappens'>
          <div className="d-flex justify-content-center yellow   flip">
            ...
            <img className="pl-0  w-50" src={EverythingHappens} alt="Modern dancer in standing position with arms bent and raised, seated dancers and projections screens in background." />
          </div>
        </Link>
      </div>
    </div >
